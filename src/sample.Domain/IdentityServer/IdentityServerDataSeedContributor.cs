...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        await CreateApiScopeAsync("sample");
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        {
            var webClientRootUrl = configurationSection["sample_App:RootUrl"]?.TrimEnd('/');
            ...
            await CreateClientAsync(
                ...
                secret: (configurationSection["sample_App:ClientSecret"] ?? "1q2w3e*").Sha256(),
        ...
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateClientAsync(
                ...
                secret: configurationSection["sample_Swagger:ClientSecret"]?.Sha256(),
                requireClientSecret: false,
